	...
	public JAgencia() {
		...
		btnGuardar.addMouseListener(new MouseAdapter() {
			...
			public void mouseClicked(MouseEvent e) {
				...
				age.create(TxtNombre.getText(), TxtDireccion.getText(), TxtTelefono.getText(), TxtCorreo.getText(),
		...
		btndelete.setIcon(
				new ImageIcon("C:\\Users\\APRENDIZ\\OneDrive\\9162995_document_email_delete_recycle_trash_icon.png"));
		btndelete.setBounds(330, 126, 57, 47);
		...
		btnconsultar.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				age.readOne(Integer.parseInt(txtidagencia.getText()), TxtNombre, TxtDireccion, TxtTelefono, TxtCorreo,
						TxtWeb, txtidcompañia);
			}
		});
		btnconsultar.setIcon(
				new ImageIcon("C:\\Users\\APRENDIZ\\OneDrive\\511943_find_loupe_magnifying glass_search_icon.png"));
		btnconsultar.setBounds(441, 126, 34, 47);
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				age.update(Integer.parseInt(txtidagencia.getText()), TxtNombre.getText(), TxtDireccion.getText(),
						TxtTelefono.getText(), TxtCorreo.getText(), TxtWeb.getText(),
						Integer.parseInt(txtidcompañia.getText()));
			}
		});
